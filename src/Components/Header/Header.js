  ...
  return (
    <div className="sticky top-0 z-10 navbar px-2 md:px-8 lg:px-28 bg-[#0e1630]">
      <div className="navbar-start">
        <a
          href="#home"
          className="btn btn-outline normal-case text-2xl text-white"
        >
      ...
      <div className="navbar-end">
        <ul className="menu menu-horizontal px-1 hidden lg:flex">{navbarLi}</ul>
        <div className="flex gap-x-3 px-2 border-x border-[#628d91]">
          {/* <p>|</p> */}
          <Link
            target="_blank"
            className=""
        ...
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-40	 right-px"
          >
            {navbarLi}
          </ul>
        </div>
